...
{\bf February 2026} \\     % change it accordingly! Put month of submission, not of thesis defense (if different)
\vspace*{.5in}
\begin{small}
{\bf \copyright{ }2026 by Lily Koffman} \\ % change the year if needed!
...
\includepdf[pages={-}, pagecommand={}]{CV_Koffman.pdf} %continue page numbering through CV
