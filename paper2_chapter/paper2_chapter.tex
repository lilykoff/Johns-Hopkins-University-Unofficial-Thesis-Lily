...
\begin{abstract}
    We propose a method for identifying individuals based on their continuously monitored wrist-worn accelerometry during activities of daily living.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\linewidth]{paper2_chapter/figure/figure1_3panel.png}
